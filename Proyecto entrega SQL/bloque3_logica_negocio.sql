...
--  Funciones escalares + Procedimientos almacenados
-- ============================================================
...
-- ------------------------------------------------------------
-- fn_calcular_total_venta
-- ------------------------------------------------------------
-- Aplica el descuento al monto bruto y devuelve el total neto.
-- Incluye guardias para valores incoherentes.
-- ------------------------------------------------------------
